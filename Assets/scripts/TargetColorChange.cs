...
public class TargetColorChange : MonoBehaviour
{
    ...
    void SetColor()
    {
        ...
        //Get the next avalable color from the target scrip manager.
    ...
    public void ResetTarget()
    {
        //Seet a new color
        SetColor();
        //To flip the target back the trigger has to be bent back. So tell the triggers script to change position.
    ...
    {
        //Start the ResisterHit Coroutine
