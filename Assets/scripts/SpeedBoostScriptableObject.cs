...
public class SpeedBoostScriptableObject : BombScriptableObject
{
    ...
    public override void AddEventHandlers()
    {
        ...
        explodeEvent.AddResultListener((timeBomb, cancelableObject) =>
        {
            ...
            {
                //Get an instance of a MonoBehaviour to start the coroutine GiveSpeedBoost. ScriptableObjects do not StartCoroutine defined in the class hierarchy.
    ...
    IEnumerator GiveSpeedBoost()
    {
        ...
        //Save values to revert to later.
        ...
        //Revert walk speed, run speed and footstep interval to their original values, therefor removing the boost.
        controller.m_WalkSpeed = saveWalkSpeed;
        controller.m_RunSpeed = saveRunSpeed;
        controller.m_StepInterval = saveStep;

        //Allow the boost to be activated again.
        isBoosted = false;
    }
}
