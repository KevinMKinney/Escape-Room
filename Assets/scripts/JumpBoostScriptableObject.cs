...
public class JumpBoostScriptableObject : BombScriptableObject
{
    ...
    //The amount of extra jump power the player gets when the boost get activated.
    [SerializeField]
    ...
    public override void AddEventHandlers()
    {
        ...
        explodeEvent.AddResultListener((timeBomb, cancelableObject) =>
        {
            ...
            {
                //Get a instance of a MonoBehaviour to start the coroutine GiveJumpBoost. ScriptableObjects do not StartCoroutine defined in the class hierarchy.
    ...
    IEnumerator GiveJumpBoost()
    {
        ...
        isBoosted = true;
        //Save the jump speed so it can revert back to the original value later.
