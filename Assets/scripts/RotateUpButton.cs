...
public class RotateUpButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    // attributes:
    Inspector inspector;
    ...
    void Update()
    {
        if (isPressed)
        {
            inspector.InspectedItem.InGameObject.GetComponent<InspectorControl>().RotateUp();
        }
    }
