...
public class PlayerPhysics : MonoBehaviour
{
    ...
    void Start()//auto generated by unity
    {
        ...
        player.transform.position = pObj.meshPosition + new Vector3(50*25, (mV[(mV.Length)/2].y*bounds.y)+mP.y, 50*25);
    ...
    void Update()//this was generated by unity
    {
        ...
        pObj.move(pObj.zBounds, pObj.xBounds, pObj.meshPosition, player.transform.forward, player.transform.right);
